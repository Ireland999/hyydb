  ...
  function ComproductsController($scope,$stateParams){
    ...
    var ConfigFun=function(){
      wx.config({
          ...
          timestamp:1427964104, // 必填，生成签名的时间戳
          nonceStr: '9dcdd4e1-4279-467b-aa4a-06f9b03e84cb', // 必填，生成签名的随机串
          signature: '3a35fc2be717f5b7b28fe1a2dfecc70ea60efe29',// 必填，签名，见附录1
